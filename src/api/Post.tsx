...
const authAPI = {
  signup: async (
    ...
    try {
      ...
      return res.data; // expects backend to return { success, user, token, message }
    } catch (err: any) {
...
export const SignupForm: React.FC<{ onSuccess: (user: User) => void }> = ({
  onSuccess,
}) => {
